...
def load_data(args, device):
    """Load SEED and corresponding text embeddings"""
...
def run_experiment(args):
    ...
    args.experiment_name = 'results_seediv'
    ...
    out_path = os.path.join(
        args.output_dir,
        f"csubsess_seediv_bd{bd_dim}_bs{args.batch_size}.csv"
    )
